...
const RULES = [
  ...
  { action: 'fb_open', re: /^(?:отвори\s+)?(?:facebook|фб|фејсбук|fb)$/iu, args: () => ({}), label: 'отвори Facebook' },
  ...
  { action: 'yt_open', re: /^(?:отвори|open)\s+(?:youtube|јутуб|yt)$/iu, args: () => ({}), label: 'отвори YouTube' },
  { action: 'browser_open', re: /^(?:отвори|open)\s+(?:instagram|инстаграм|ig)$/iu, args: () => ({ url: 'https://www.instagram.com/' }), label: 'отвори Instagram' },
  ...
  { action: 'browser_open', re: /^(?:отвори|open)\s+(?:google|гугл)$/iu, args: () => ({ url: 'https://www.google.com/' }), label: 'отвори Google' },
